...
--	end)
	...
	test('a method named "ext"', function()
		assert_type(aclass.ext, 'function')
	end)
...
context('a class also implements some attributes', function()
	...
	test('yet it returns "Object" in case the class is unnamed', function()
		assert_equal(class().name, "Object")
	end)

	test('it also has an attribute "super" which equals class.Object', function()
		assert_equal(aclass.super, class.Object)
	end)
	...
	test('and some private metamethods meant for its instances', function()
		...
		assert_type(aclass.__index,    'function')
	end)
